...
This table provides a quick reference for converting between decimal (Dec) and hexadecimal (Hex) values in the range 128–255 (0x80–0xFF). This is useful for interpreting binary data, ASCII codes, and protocol fields in APRS and AX.25 packet analysis.
...
- To convert decimal 200 to hex: find 200 in the "Dec" column, see that it matches "c8" in the "Hex" column.
- To convert hex "e2" to decimal: find "e2" in the "Hex" column, see that it matches 226 in the "Dec" column.

> This table is especially useful for interpreting binary and hexadecimal data in APRS, AX.25, and related packet radio protocols.